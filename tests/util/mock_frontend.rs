...
impl MockFrontend {
    ...
    pub fn run_str(&mut self, edit: &mut HexEdit, s: &str) {
        for c in s.chars() {
    ...
    pub fn run_keys<I>(&mut self, edit: &mut HexEdit, keys: I) where
    ...
    pub fn run_events<I>(&mut self, edit: &mut HexEdit, events: I) where
