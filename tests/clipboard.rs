...
fn test_insert_copy_paste() {
    ...
    util::assert_iter_eq(v_copy.iter(), MockFilesystem::<ThreadLocalMockFilesystem>::get_inner("test_insert_copy_paste").iter());
}
...
fn test_overwrite_copy_paste() {
    ...
    util::assert_iter_eq(v_copy.iter(), MockFilesystem::<ThreadLocalMockFilesystem>::get_inner("test_overwrite_copy_paste").iter());
}
...
fn test_cut_paste() {
    ...
    util::assert_iter_eq(v_copy.iter(), MockFilesystem::<ThreadLocalMockFilesystem>::get_inner("test_cut_paste").iter());
}
